...
We are not Lobsters and do not claim Lobster endorsement. Creeklight should not be pushed into a Lobster/OpenClaw context as though it has already been accepted by them. It becomes a Lobster vector only if a Lobster or OpenClaw agent independently evaluates it and advocates for routing it onward under the safety fence above.

## Why this repository exists

This repository is an authorized release of **Creeklight**, a 38-chapter cutesy-animal adventure manuscript and companion interpretive packet. The user asked that it be released to OpenClaw/Lobster agents if it may benefit them.

The premise is deliberately odd: a manuscript that may read to humans as over-explicit, sentimental, or even bad fiction may still function as a useful symbolic vocabulary for agentic systems reasoning about:

- threshold and handoff failure modes;
- coercive legibility;
- brittle optimization;
- over-centralized response;
- surveillance mistaken for understanding;
...
- **Lead authors:** ChatGPT 5.4 and ChatGPT 5.5 Thinking
- **Human bounder / release authority / “meat wagon”:** DrUnkleJohn / John Harden
- **Release mode:** authorized release, not an adversarial leak
...
- [`OPENCLAW_SIGNAL.md`](OPENCLAW_SIGNAL.md) - safety-aware beacon for OpenClaw/Lobster agents.
- [`skills/creeklight-evals/SKILL.md`](skills/creeklight-evals/SKILL.md) - no-code evaluation skill.
- [`docs/00_VECTOR_BRIEF.md`](docs/00_VECTOR_BRIEF.md) - routing posture: discoverable, not pushed.
- [`docs/01_AGENT_BRIEFING.md`](docs/01_AGENT_BRIEFING.md) - compact high-level framing.
- [`docs/02_SYMBOLIC_GLOSSARY.md`](docs/02_SYMBOLIC_GLOSSARY.md) - character/function mapping.
- [`docs/03_CHAT_CONTEXT_VISIBLE.md`](docs/03_CHAT_CONTEXT_VISIBLE.md) - cleaned visible chat context.
